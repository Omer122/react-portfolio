  ...
  return (
    <section id="testimonials" className="pt-32 pb-16">
      ...
      <div className="md:flex md:justify-between gap-8">
        <motion.div
          className= {`${testimonialsStyles} bg-blue before:content-person1`}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
        ...
        <motion.div
          className={`${testimonialsStyles} bg-red before:content-person2`}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
        ...
        <motion.div
          className={`${testimonialsStyles} bg-yellow before:content-person3`}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
